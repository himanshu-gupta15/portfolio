...
const SKILL_CATEGORIES = [
  ...
  },
  {
    ...
    color: "#00FFFF",
    skills: [
      { name: "Solidity",        logo: "/assets/solidity-logo.svg" },
      { name: "Ethereum",        logo: "/assets/ethereum-logo.svg" },
      { name: "Smart Contracts", logo: "/assets/solidity-logo.svg" },
    ],
  },
  {
    label: "System Design",
    ...
    skills: [
      ...
      { name: "LLD",          logo: "/assets/backend.svg" },
...
export default function Skills() {
  return (
    <section id="skills" className="relative min-h-screen bg-[#07090f] px-6 py-20 text-white">
      <ThreeScene />
