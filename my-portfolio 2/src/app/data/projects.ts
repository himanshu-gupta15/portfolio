...
Integrated a real-time Supabase PostgreSQL database for managing student enrollments, teacher records, and attendance logs.`,
    image: "/project/SnapClass/img.jpg",
    tech: ["Python", "Streamlit", "dlib", "SVM", "Resemblyzer", "Supabase", "Machine Learning"],
    github: "https://github.com/himanshu-gupta15/AI_Attendence_System.git",
...
Integrated Google Gemini AI for Resume Analyzer and Career Guide features, along with Razorpay for premium subscriptions and Cloudinary for secure file storage.`,
    image: "/project/CarerLunch/img1.png",
    tech: ["Next.js", "TypeScript", "Tailwind CSS", "Kafka", "Redis", "PostgreSQL", "Gemini AI"],
    github: "https://github.com/himanshu-gupta15/JobPortal.git",
...
Used MongoDB, Redis, Redux, React Router, and Tailwind CSS for scalable backend and responsive frontend development.`,
    image: "/project/algorise/img1.png",
    tech: ["React", "Node.js", "Express.js", "MongoDB", "Redis", "Redux", "Tailwind CSS"],
    github: "https://github.com/himanshu-gupta15/Alogrise.git",
